...
# (Published on Friday, 3rd March 2006, 06:00 pm; Solved by 5824)
# 
#     A row of five black square tiles is to have a number of its
# 	tiles replaced with coloured oblong tiles chosen from red (length
# 	two), green (length three), or blue (length four).
# 
...
# 	ways of replacing the black tiles in a row measuring five units in
# 	length.
# 
...
# 	[117](index.php?section=problems&id=117).
