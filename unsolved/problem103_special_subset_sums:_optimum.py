...
# (Published on Friday, 26th August 2005, 06:00 pm; Solved by 3647)
# 
...
# 	previous row.
# 
#     By applying this "rule" we would expect the optimum set for n =
# 	6 to be A = {11, 17, 20, 22, 23, 24}, with S(A) = 117. However,
# 	this is not the optimum set, as we have merely applied an algorithm
# 	to provide a near optimum set. The optimum set for n = 6 is A =
# 	{11, 18, 19, 20, 22, 25}, with S(A) = 115 and corresponding set
# 	string: 111819202225.
# 
#     Given that A is an optimum special sum set for n = 7, find its
# 	set string.
# 
#     NOTE: This problem is related to problems
# 	[105](index.php?section=problems&id=105) and
# 	[106](index.php?section=problems&id=106).
