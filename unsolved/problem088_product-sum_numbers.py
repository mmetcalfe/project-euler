...
# (Published on Friday, 4th February 2005, 06:00 pm; Solved by 4183)
# 
#     A natural number, N, that can be written as the sum and product
# 	of a given set of at least two natural numbers, {a_{1}, a_{2}, ...
# 	, a_{k}} is called a product-sum number: N = a_{1} + a_{2} + ... +
# 	a_{k} = a_{1} × a_{2} × ... × a_{k}.
# 
