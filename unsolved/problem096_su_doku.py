# 
# Problem 96: Su Doku
# (Published on Friday, 27th May 2005, 06:00 pm; Solved by 7822)
# 
...
# 	deduction.
# 
#     The 6K text file, [sudoku.txt](project/sudoku.txt) (right click
# 	and 'Save Link/Target As...'), contains fifty different Su Doku
# 	puzzles ranging in difficulty, but all with unique solutions (the
...
# 	solution grid above.
# <p class='info'>Note: If you're convinced that &quot;guess and
# 	test&quot; methods need not be employed please tell how you would
# 	solve #6 and #46. (c;</p>
