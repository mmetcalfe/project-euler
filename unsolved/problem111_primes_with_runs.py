...
# (Published on Friday, 16th December 2005, 06:00 pm; Solved by 3462)
# 
#     Considering 4-digit primes containing repeated digits it is
# 	clear that they cannot all be the same: 1111 is divisible by 11,
...
# 	repeated digits for an n-digit prime where d is the repeated digit,
