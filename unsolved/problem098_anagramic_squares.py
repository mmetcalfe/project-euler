...
# (Published on Friday, 17th June 2005, 06:00 pm; Solved by 4939)
# 
#     By replacing each of the letters in the word CARE with 1, 2, 9,
# 	and 6 respectively, we form a square number: 1296 = 36^{2}. What is
...
# 
#     Using [words.txt](project/words.txt) (right click and 'Save
