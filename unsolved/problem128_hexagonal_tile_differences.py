...
# (Published on Friday, 29th September 2006, 06:00 pm; Solved by 2275)
# 
...
# 	being numbered 8 to 19, 20 to 37, 38 to 61, and so on. The diagram
# 	below shows the first three rings.
# 
# <img alt="" height="431" src="project/images/p_128.gif"
# 	width="400"/>
...
# 
#     In the same way, the differences around tile 17 are 1, 17, 16,
# 	1, 11, and 10, hence PD(17) = 2.
# 
