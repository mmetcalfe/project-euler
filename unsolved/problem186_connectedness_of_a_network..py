...
# 	and Y are friends if X calls Y or vice-versa. Similarly, X is a
# 	friend of a friend of Z if X is a friend of Y and Y is a friend of
# 	Z; and so on for longer chains.
# 
