...
# (Published on Friday, 15th April 2005, 06:00 pm; Solved by 5163)
# 
...
# 
#     Find the set of four distinct digits, a < b &lt c < d, for which
# 	the longest set of consecutive positive integers, 1 to n, can be
