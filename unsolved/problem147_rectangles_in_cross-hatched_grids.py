...
# (Published on Saturday, 31st March 2007, 06:00 am; Solved by 1410)
# 
...
# 
# <img alt="" height="176" src="project/images/p_147.gif"
# 	width="361"/>
#     There are 5 grids smaller than 3x2, vertical and horizontal
# 	dimensions being important, i.e. 1x1, 2x1, 3x1, 1x2 and 2x2. If
# 	each of them is cross-hatched, the following number of different
