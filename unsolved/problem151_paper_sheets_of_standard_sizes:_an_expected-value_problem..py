...
# (Published on Friday, 20th April 2007, 06:00 pm; Solved by 2632)
# 
...
# 
# <img alt="" height="227" src="project/images/p_151.gif"
# 	width="314"/>
...
# 	it. If it is larger, he repeats the 'cut-in-half' procedure until
# 	he has what he needs and any remaining sheets are always placed
# 	back in the envelope.
# 
#     Excluding the first and last batch of the week, find the
# 	expected number of times (during each week) that the foreman finds
# 	a single sheet of paper in the envelope.
# 
