...
# (Published on Friday, 18th February 2005, 06:00 pm; Solved by 10235)
# 
#     The rules for writing Roman numerals allow for many ways of
# 	writing each number (see [About Roman
# 	Numerals...](about=roman_numerals)). However, there is always a
...
# 
#     The 11K text file, [roman.txt](project/roman.txt) (right click
# 	and 'Save Link/Target As...'), contains one thousand numbers
# 	written in valid, but not necessarily minimal, Roman numerals; that
# 	is, they are arranged in descending units and obey the subtractive
# 	pair rule (see [About Roman Numerals...](about=roman_numerals) for
