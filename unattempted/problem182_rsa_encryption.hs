...
-- (Published on Friday, 15th February 2008, 01:00 pm; Solved by 1491)
-- 
...
-- 	calculate d such that ed=1 mod φ, then for each encrypted message,
...
-- 
-- If we choose e=181, then, although gcd(181,648)=1 it turns out that
