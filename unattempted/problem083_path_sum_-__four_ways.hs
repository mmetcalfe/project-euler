...
-- (Published on Friday, 19th November 2004, 06:00 pm; Solved by 10062)
-- 
--     NOTE: This problem is a significantly more challenging version
-- 	of [Problem 81](problem=81).
-- 
...
-- 	[matrix.txt](project/resources/p083_matrix.txt) (right click and
