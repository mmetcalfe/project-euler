...
-- (Published on Friday, 15th June 2007, 02:00 pm; Solved by 2110)
-- 
--     Taking three different letters from the 26 letters of the
-- 	alphabet, character strings of length three can be formed.
-- 
...
-- 	exactly one character comes lexicographically after its neighbour
-- 	to the left.
-- 
