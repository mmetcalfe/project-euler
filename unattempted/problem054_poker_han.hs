...
# (Published on Friday, 10th October 2003, 06:00 pm; Solved by 15702)
# 
...
# 
# 
#     The file, [poker.txt](project/poker.txt), contains one-thousand
# 	random hands dealt to two players. Each line of the file contains
# 	ten cards (separated by a single space): the first five are Player
# 	1's cards and the last five are Player 2's cards. You can assume
