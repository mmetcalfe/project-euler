...
-- (Published on Saturday, 5th May 2007, 10:00 am; Solved by 1402)
-- 
...
-- <img alt="" border="0" src="project/images/p153_formule1.gif" style
-- 	="vertical-align:middle"/> in the following manner:
-- 
-- Multiply numerator and denominator by the complex conjugate of 1+2i:
-- 	1−2i.
-- 
-- The result is
-- <img alt="" border="0" src="project/images/p153_formule2.gif" style
-- 	="vertical-align:middle;"/>.
-- 
-- So 1+2i is a divisor of 5.
-- 
-- Note that 1+i is not a divisor of 5 because
-- <img alt="" border="0" src="project/images/p153_formule5.gif" style
-- 	="vertical-align:middle;"/>.
-- 
...
-- <img alt="" border="0" src="project/images/p153_formule6.gif" style
-- 	="vertical-align:middle"/>.
-- 
