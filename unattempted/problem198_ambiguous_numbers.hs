...
-- (Published on Saturday, 14th June 2008, 02:00 am; Solved by 629)
-- 
--     A best approximation to a real number x for the denominator
-- 	bound d is a rational number r/s (in reduced form) with s ≤ d, so
-- 	that any rational number p/q which is closer to x than r/s has q >
-- 	d.
-- 
--     Usually the best approximation to a real number is uniquely
-- 	determined for all denominator bounds. However, there are some
-- 	exceptions, e.g. 9/40 has the two best approximations 1/4 and 1/5
