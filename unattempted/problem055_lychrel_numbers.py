...
# (Published on Friday, 24th October 2003, 06:00 pm; Solved by 26046)
# 
...
# 	Lychrel number. Due to the theoretical nature of these numbers, and
# 	for the purpose of this problem, we shall assume that a number is
# 	Lychrel until proven otherwise. In addition you are given that for
# 	every number below ten-thousand, it will either (i) become a
# 	palindrome in less than fifty iterations, or, (ii) no one, with all
