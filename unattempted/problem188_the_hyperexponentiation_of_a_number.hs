...
-- (Published on Friday, 4th April 2008, 02:00 pm; Solved by 4018)
-- 
...
-- 
-- 
-- Thus we have e.g. 3↑↑2 = 3^{3} = 27, hence 3↑↑3 = 3^{27} =
-- 	7625597484987 and 3↑↑4 is roughly 10^{3.6383346400240996*10^12}.
-- 
