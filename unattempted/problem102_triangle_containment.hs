...
-- (Published on Friday, 12th August 2005, 06:00 pm; Solved by 12378)
-- 
...
-- 	(right click and 'Save Link/Target As...'), a 27K text file
-- 	containing the co-ordinates of one thousand "random" triangles,
-- 	find the number of triangles for which the interior contains the
-- 	origin.
-- 
