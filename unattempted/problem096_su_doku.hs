-- 
-- Problem 96: Su Doku
-- (Published on Friday, 27th May 2005, 06:00 pm; Solved by 9303)
-- 
...
-- 
--     The 6K text file,
-- 	[sudoku.txt](project/resources/p096_sudoku.txt) (right click and
-- 	'Save Link/Target As...'), contains fifty different Su Doku puzzles
-- 	ranging in difficulty, but all with unique solutions (the first
