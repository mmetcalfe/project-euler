...
-- (Published on Friday, 18th February 2005, 06:00 pm; Solved by 12440)
-- 
--     For a number written in Roman numerals to be considered valid
-- 	there are basic rules which must be followed. Even though the rules
...
-- 	and the last example is considered to be the most efficient, as it
...
-- 	numbers written in valid, but not necessarily minimal, Roman
-- 	numerals; see [About... Roman Numerals](about=roman_numerals) for
