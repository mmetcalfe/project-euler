...
-- (Published on Friday, 16th January 2004, 06:00 pm; Solved by 13632)
-- 
...
-- 
--         Triangle            P_{3,n}=n(n+1)/2            1, 3, 6, 10,
-- 	15, ...
--      Square         P_{4,n}=n^{2}           1, 4, 9, 16, 25, ...
--     Pentagonal          P_{5,n}=n(3n−1)/2           1, 5, 12, 22,
-- 	35, ...
--     Hexagonal           P_{6,n}=n(2n−1)         1, 6, 15, 28, 45,
-- 	...
--     Heptagonal          P_{7,n}=n(5n−3)/2           1, 7, 18, 34,
-- 	55, ...
...
-- 	(P_{4,91}=8281), and pentagonal (P_{5,44}=2882), is represented by
...
-- 	pentagonal, hexagonal, heptagonal, and octagonal, is represented by
-- 	a different number in the set.
