...
-- (Published on Friday, 29th August 2003, 06:00 pm; Solved by 17217)
-- <p>By replacing the 1<sup>st</sup> digit of *57, it turns out that
-- 	six of the possible values: 157, 257, 457, 557, 757, and 857, are
-- 	all prime.</p>
--     By replacing the 1^{st} digit of the 2-digit number *3, it turns
-- 	out that six of the nine possible values: 13, 23, 43, 53, 73, and
-- 	83, are all prime.
-- 
