...
-- (Published on Saturday, 21st June 2008, 06:00 am; Solved by 1070)
-- 
...
-- 
-- <img alt="" src="project/images/p199_circles_in_circles.gif"/>
-- 
...
-- 	(pictured), there are 108 gaps and the fraction of the area which
-- 	is not covered by circles is 0.06790342, rounded to eight decimal
-- 	places.
-- 
-- 
