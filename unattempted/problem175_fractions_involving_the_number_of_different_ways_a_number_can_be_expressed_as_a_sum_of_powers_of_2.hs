...
-- (Published on Friday, 28th December 2007, 01:00 pm; Solved by 1052)
-- 
-- Define f(0)=1 and f(n) to be the number of ways to write n as a sum
-- 	of powers of 2 where no power occurs more than twice.
-- 
-- 
-- 
