...
# (Published on Friday, 21st October 2005, 06:00 pm; Solved by 5242)
# 
#     The following undirected network consists of seven vertices and
# 	twelve edges with a total weight of 243.
# 
# <img alt="" height="278" src="project/images/p_107_1.gif"
# 	width="381"/>
# 
...
# 
# <img alt="" height="288" src="project/images/p_107_2.gif"
# 	width="385"/>
# 
#     Using [network.txt](project/network.txt) (right click and 'Save
# 	Link/Target As...'), a 6K text file containing a network with forty
# 	vertices, and given in matrix form, find the maximum saving which
# 	can be achieved by removing redundant edges whilst ensuring that
