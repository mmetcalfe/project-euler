...
-- (Published on Friday, 30th May 2008, 06:00 pm; Solved by 1431)
-- 
...
-- . . .
-- 
--     Each positive integer has up to eight neighbours in the
-- 	triangle.
-- 
--     A set of three primes is called a prime triplet if one of the
...
-- 
--     If row 8 is considered, it contains two primes which are
-- 	elements of some prime triplet, i.e. 29 and 31.
-- 
